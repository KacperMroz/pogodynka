...
@injectable
class GetWeatherByLocationTomorrowApiUseCase{
  GetWeatherByLocationTomorrowApiUseCase(this._apiService);
  final ApiService _apiService;

  Future<Either<Error, Weather>> call(Location location) async =>
      (await _apiService.getWeatherByLocationTomorrowApi(location));
